            ...
            <q-card-section class="text-subtitle2">
              <div v-for="(men, index) in menu" :key="index">
                <div class="q-pa-sm"></div>
                  <q-btn :color="men.color" :icon="men.icon" :label="men.name" style="width: 250px;" @click="tousers(men.to)" />
              </div>
            </q-card-section>
          </div>
        </q-slide-transition>
...
const menu = [
  ...
  { id: 3, name: "Usuarios X Sucursal", icon: "store", color: "primary", to:'usuarios/branch' },
]
